  ...
  return (
    <div className="w-full h-screen flex justify-center relative items-center">
      ...
      <div className="hero-section w-full h-screen flex justify-center items-end absolute top-0 z-10 left-0">
        <div className="w-[90%] h-auto flex gap-4  2xl:items-center 2xl:justify-between items-end">
          <div className="content w-1/2 2xl:max-w-3xl flex flex-col gap-3 mb-20 h-auto pl-5 justify-center">
            <h1 className="text-8xl font-normal leading-28 text-primary">
              Discover the Magic of Chai
            </h1>
            <p className="text-base max-w-xl 2xl:text-xl font-normal text-primary font-sans">
          ...
          <div className="content w-1/2  flex h-auto justify-center items-end">
            <Image
              ...
              width={400}
              height={400}
              className="object-cover 2xl:w-[80%] w-[90%]"
            />
          </div>
        </div>
      </div>
